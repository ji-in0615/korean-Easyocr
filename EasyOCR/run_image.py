...
result = reader.readtext('/data/IMT/ocr_ko/sample_images/002.jpg')

img    = cv2.imread('/data/IMT/ocr_ko/sample_images/002.jpg')

img = Image.fromarray(img)
font = ImageFont.truetype("NanumBarunGothic.ttf",20)
