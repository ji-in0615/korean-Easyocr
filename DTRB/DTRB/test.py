...
def benchmark_all_eval(model, criterion, converter, opt, calculate_infer_time=False):
    ...
    log = open(f'/data/IMT/ocr_ko/data_ko/result/{opt.exp_name}/log_all_evaluation.txt', 'a')
...
def test(opt):
    ...
    os.makedirs(f'/data/IMT/ocr_ko/data_ko/result/{opt.exp_name}', exist_ok=True)
    os.system(f'cp {opt.saved_model} /data/IMT/ocr_ko/data_ko/result/{opt.exp_name}/')
    ...
    with torch.no_grad():
        if opt.benchmark_all_eval:  # evaluation with 10 benchmark evaluation datasets
            ...
            log = open(f'/data/IMT/ocr_ko/data_ko/result/{opt.exp_name}/log_evaluation.txt', 'a')
            AlignCollate_evaluation = AlignCollate(imgH=opt.imgH, imgW=opt.imgW, keep_ratio_with_pad=opt.PAD)
